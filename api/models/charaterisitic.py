...
class FoodCharacteristic(db.Model):
    ...
    food_id=db.Column(db.Integer,db.ForeignKey('foods.id'),nullable=False,unique=True)

    def __init__(self,food_id=None,Agirlik=None,Karbonhidrat=None,Protein=None,Yag=None):
